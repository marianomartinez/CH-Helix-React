    ...
    <Navbar className="bg-secondary rounded-bottom" expand="md">
      ...
      <Navbar.Collapse id="basic-navbar-nav">
        ...
        <Form inline>
          ...
          <button className="btn btn-secondary shadow-none"><svg width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
